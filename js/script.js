...
DataSave:function(dataSave){
  ...
  MDataPopulate:function(){
    ...
    var loc01 = {'m1':[0,45],'m2':[0,45],'m3':[1, 10],'m4':[0, 45],'m5':[0, 45],'m6':[0, 0],'m7':[0, 0],'m8':[0, 0],'m9':[0, 0],'m10':[0, 0],'survey':[0, 10]}
    ...
    var i=0;
	var TmpArray={'m1':'headingSix','m2':'headingSeven','m3':'headingEight','m4':'headingTen','m5':'headingEleven','m6':'headingThirteen','m7':'headingFourteen'};
	if(app.SelecteM !="survey")
	{
  ...
  CDataPopulate:function(collections){
    ...
    var loc01 = {'c1':[2,50],'c2':[1,40],'c3':[2, 55],'c4':[0, 00]}
  ...
  SDataPopulate:function(j){
	...
	{
		var xPath='';
		if(app.MData.m1.status=='complete' && app.MData.m2.status=='complete' && app.MData.m3.status=='complete' && app.SelecteM=='survay_m1')
		{
			xPath="//"+app.SelecteM+"/complete";
		}
		else if(app.MData.m4.status=='complete' && app.MData.m5.status=='complete' && app.SelecteM=='survay_m2')
		{
			xPath="//"+app.SelecteM+"/complete";
		}
		else{
			xPath="//"+app.SelecteM+"/not_complete";
		}
	...
	if(app.ClickOnModule == 'module1' || app.ClickOnModule == 'module2' || app.ClickOnModule == 'module4' || app.ClickOnModule == 'module5'|| app.ClickOnModule == 'module6'|| app.ClickOnModule == 'module7') {
	...
	if(app.survey_response1=='complete')
	   ...
	   if(app.survey_response2=='complete')
	   {
	    ...
	    if(app.survey_response3=='complete')
	   {
		$('#collapseThirteen .text-center.small').text('complete');
		$('#collapseThirteen').addClass('complete');
		$('#headingThirteen .text-center.small span').text('complete');
		$('#headingThirteen .text-center.small span').css({"color":'#43bea7'});
		$('#headingThirteen .CollectionText').addClass('complete');
	   }
	 /*  if(app.survey_response4=='complete')
	   {
		$('#collapseTwelve .text-center.small').text('complete');
...
else if (app.SelecteM == 'm4') {
      var timeFixed = [[00,02],[00,10],[00,10],[00,05],[00,12],[00,06],[00,07],[00,15],[00,03],[00,03]];
...
else if (app.SelecteM == 'm5') {
      var timeFixed = [[00,02],[00,10],[00,10],[00,05],[00,12],[00,06],[00,07],[00,15],[00,03],[00,03],[00,03]];
  ...
  Events:function(){ 
	...
	$(".btnss").hover(function(e){
	  ...
	  else if(MD_no=="module2")
	  {
		app.SelecteM='m2';
	  }
	  else if(MD_no=="module3")
	  {
		app.SelecteM='m3';
	  }
	  else if(MD_no=="module4")
	  {
		app.SelecteM='m4';
	  }
	  else if(MD_no=="module5")
	  {
		app.SelecteM='m5';
	  }
	  else if(MD_no=="module6")
	  {
		app.SelecteM='m6';
	  }
	  else if(MD_no=="module7")
	  {
		app.SelecteM='m7';
	  }
